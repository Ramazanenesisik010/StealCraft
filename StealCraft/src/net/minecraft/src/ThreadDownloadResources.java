...
public class ThreadDownloadResources extends Thread
{
    ...
    public void run()
    {
        try
        {
        	URL var1 = new URL("https://ramazanenesisik010.github.io/stealcraft_sound_web/");
            URLConnection yc = var1.openConnection();
            ...
            String[] soundPath = text.split(",");

            for (int var6 = 0; var6 < 2; ++var6)
            {
                for (int var7 = 0; var7 < soundPath.length; ++var7)
                {   
                    this.downloadAndInstallResource(var1, soundPath[var7], 1L, var6);
     ...
     */
    public static void downloadResource(URL par1URL, File par2File, long par3) throws IOException
    {
