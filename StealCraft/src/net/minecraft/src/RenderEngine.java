...
public class RenderEngine
{
    ...
    public void LocalbindTexture(String par1Str)
    {
        this.bindTexture(this.getFileTexture(par1Str));
    }
    
    public void LocalbindTexture(String par1Str, int width,int heigth)
    {
        this.bindTexture(this.getFileTexture(par1Str,width,heigth));
    }
    ...
    private int getFileTexture(String par1Str)
    {
        if (par1Str.equals("/terrain.png"))
        {
            this.textureMapBlocks.getTexture().bindTexture(0);
        ...
        else
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    InputStream var6 = new FileInputStream(par1Str);
    ...
    private int getFileTexture(String par1Str,int width,int heigth)
    {
        if (par1Str.equals("/terrain.png"))
        {
            this.textureMapBlocks.getTexture().bindTexture(0);
        ...
        else
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    {
                        this.setupTextureExt(this.readTextureImage2(var6,width,heigth), var3, var9, var5);
                    }
    ...
    private BufferedImage readTextureImage2(InputStream par1InputStream,int width,int heigth) throws IOException
    {
        BufferedImage var2 = ImageIO.read(par1InputStream);

        BufferedImage image = new BufferedImage(width,heigth,BufferedImage.TYPE_INT_ARGB);
        
        Graphics2D grb = image.createGraphics();
        grb.drawImage(var2, 0, 0,width,heigth, null);
        grb.dispose();
        return image;
    }
