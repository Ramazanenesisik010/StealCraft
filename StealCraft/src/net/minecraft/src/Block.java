...
public class Block
{
    ...
    public static final Block barrier = (new BlockBarrier(159,Material.cake)).setBlockUnbreakable().setResistance(6000000.0F).setStepSound(soundStoneFootstep).setUnlocalizedName("barrier");
    //public static final Block using_barrier = (new BlockBarrier(160,Material.cake)).setBlockUnbreakable().setResistance(6000000.0F).setStepSound(soundStoneFootstep).setUnlocalizedName("using_barrier");
