...
public class EntityPlayerSP extends EntityPlayer
{
    ...
    public EntityPlayerSP(Minecraft par1Minecraft, World par2World, Session par3Session, int par4)
    {
        ...
        {
            this.skinUrl = "https://ramazanenesisik010.github.io/stealcraft_web/skins/" + StringUtils.stripControlCodes(par3Session.username) + ".png";
        }
    ...
    public void onLivingUpdate()
    {
        ...
        else
        {
            ...
            /*if (this.inventory.getCurrentItem().getItem() == Item.barrier) {
            	BlockCoords[] coords = this.mc.theWorld.getBlockCoords(Block.barrier.blockID);
            	for(int i = 0; i < coords.length; i++) {
            		this.mc.theWorld.notifyBlockChange(coords[i].x, coords[i].y, coords[i].z, Block.using_barrier.blockID);
            	}
            } else {
            	BlockCoords[] coords = this.mc.theWorld.getBlockCoords(Block.using_barrier.blockID);
            	for(int i = 0; i < coords.length; i++) {
            		this.mc.theWorld.notifyBlockChange(coords[i].x, coords[i].y, coords[i].z, Block.barrier.blockID);
            	}
            }*/
