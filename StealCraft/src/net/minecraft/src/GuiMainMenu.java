...
import com.emirenesgames.GuiLinkScreen;
...
public class GuiMainMenu extends GuiScreen
{
    ...
    public GuiMainMenu()
    {
        ...
        {
            this.field_92025_p = "" + EnumChatFormatting.BOLD + "Notice!" + EnumChatFormatting.RESET + " PowerPC compatibility will be dropped in StealCraft";
            this.field_104024_v = "http://tinyurl.com/javappc";
        }
        else if (var3 != null && var3.startsWith("1.5"))
        {
            this.field_92025_p = "" + EnumChatFormatting.BOLD + "Notice!" + EnumChatFormatting.RESET + " Java 1.5 compatibility will be dropped in StealCraft";
            this.field_104024_v = "http://tinyurl.com/javappc";
        }
    }
    ...
    public void initGui()
    {
        ...
        else if (var1.get(2) + 1 == 9 && var1.get(5) == 12)
        {
            this.splashText = "Happy birthday Enes and Emir!!";
        }
    ...
    private void addSingleplayerMultiplayerButtons(int par1, int par2, StringTranslate par3StringTranslate)
    {
        ...
        this.buttonList.add(new GuiButton(7, this.width / 2 - 100, par1 + par2 * 2 ,"Feedback"));
    }
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        ...
        {
            this.mc.displayGuiScreen(new GuiLinkScreen(this,"https://forms.gle/Uxt6ijhr3fhTKuXq8"));
        }
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        this.drawTexturedModalRect(var6 + 0, var7 + 0, 0, 0, 256, 46);
        ...
        GL11.glPopMatrix();
        String var9 = "StealCraft " + ConfigClass.VERSION;
        ...
        String var10 = "Copyright Emir Enes Games Lnc. Do not distribute!";
