...
public class ContainerEnchantment extends Container
{
    ...
    public IInventory tableInventory = new SlotEnchantmentTable(this, "Enchant", true, 2);
    ...
    public ContainerEnchantment(InventoryPlayer par1InventoryPlayer, World par2World, int par3, int par4, int par5)
    {
        ...
        this.posY = par4;
        this.posZ = par5;
        this.addSlotToContainer(new SlotEnchantment(this, this.tableInventory, 0, 9, 47));
        this.addSlotToContainer(new SlotEnchantment(this, this.tableInventory, 1, 34, 47));
        int var6;
    ...
    public boolean enchantItem(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        ItemStack va5 = this.tableInventory.getStackInSlot(1);

        if (this.enchantLevels[par2] > 0 && var3 != null && (par1EntityPlayer.experienceLevel >= this.enchantLevels[par2] || par1EntityPlayer.capabilities.isCreativeMode) && va5 != null && va5.itemID == Item.dyePowder.itemID)
        {
            if (!this.worldPointer.isRemote)
            {
